...
# -------------------------------------------------------------------
class StressTestFormat(Recipe.Format):
    def sigil(self, r):
        return f'{r.name} {r.arg("program").rtarget()}'
...
# -------------------------------------------------------------------
class TestFormat(Recipe.Format):
    def sigil(self, r):
        return f"{r.name} {r.program_name()}"
...
# -------------------------------------------------------------------
@recipe(factory=True, fmt=TestFormat())
def test(t):
    result = sh(
        t.target,
        t=t,
